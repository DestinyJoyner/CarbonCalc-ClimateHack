    ...
    <div className="results">
      ...
      <div className="results-chart">
        ...
        <section className="monthly">
          <h4>Annually</h4>
          <span
          style={compare> 13.68 ? {color : "red"}: {color : "green"}}>{compare.toFixed(2)}</span>
        </section>
      </div>
      ...
      <span>
          ...
          <p>
            <span>USA (13.68)</span>
            <img className="arrow" src = {compare > 13.68 ? up : down } alt = "arrow" />
            </p>
          </span>
        <span>
          ...
          <p>
            ...
            <img className="arrow" src = {compare > 8.39 ? up : down } alt = "arrow" />
          </p>
        </span>
        <span>
          ...
          <p>
            ...
            <img className="arrow" src = {compare > 1.8 ? up : down } alt = "arrow" />
          </p>
        </span>
        <span>
          ...
          <p>
            ...
            <img className="arrow" src = {compare > .64 ? up : down } alt = "arrow" />
          </p>
        </span>
      </section>
